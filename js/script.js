...
/* Home Page Mobile version Menu Script iphone fix*/
  ...
  $('#tabMenu li').click(function(){
	...
	$('.dpt').hover ( function()
	{	$('.dpt_info', this).stop().animate({'padding':'0px', width: '100%'}).animate({height: '100px'},{queue:false, duration:'fast', easing:'linear'});
	}, function()
	{
		$('.dpt_info',this).stop().animate({height: '39px'}).animate({'padding-left':'15px', width: '125px'},{queue:false, duration:'fast', easing:'linear'});
	});
